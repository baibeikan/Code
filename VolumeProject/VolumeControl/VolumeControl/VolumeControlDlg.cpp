...
// CVolumeControlDlg 对话框




CVolumeControlDlg::CVolumeControlDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CVolumeControlDlg::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CVolumeControlDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
// CVolumeControlDlg 消息处理程序
#include "Volume_Win7.h"
BOOL CVolumeControlDlg::OnInitDialog()
{
	...
	// TODO: 在此添加额外的初始化代码
	//Volume_Win7 volume;
	//float acode = volume.GetVolume();

	//int a = acode * 100;

	//volume.ChangeVolume(0);
	//volume.MuteDevice(false);
	int nSleep = 2000;
